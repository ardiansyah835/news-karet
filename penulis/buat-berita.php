    ...
    <aside id="sidebar" class="sidebar">
      <ul class="sidebar-nav" id="sidebar-nav">
        <li class="nav-item">
          <a
            class="nav-link"
            href="http://<?= $_SERVER['SERVER_NAME'] ?>/news-karet/penulis/"
          >
        ...
        <li class="nav-item">
          <a
            ...
            href="http://<?= $_SERVER['SERVER_NAME'] ?>/news-karet/penulis/buat-berita.php"
          >
            ...
            <div class="row">
              ...
              <div class="card" style="margin-left: 11px;">
                <div class="card-body" style="padding-top: 20px;">
                  Silahkan <span style="color: red;"> Buat berita</span> sesuai dengan pilihannya
                </div>
              </div>
