        ...
        <div class="row space-100">
          <div class="col-lg-6 col-md-12 col-xs-12">
            <div data-aos="fade-right" class="contents">
              <h2 class="head-title">Kamu berada di <text style="color: #3ECF8E;;">Menu teknologi</text></h2>
              <p>
                Di menu <text style="color: #3ECF8E;;">Teknologi</text> ini kalian akan menemukan berita tentang <text style="color: #3ECF8E;;">Teknologi</text> untuk wilayah Kp. karet
              </p>
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="blog-text section-header text-center">
              <div>
                <h2 class="section-title">Kategori hiburan</h2>
                <div class="desc-text">
                  <p>Berikut adalah berita denga kategori <text style="color: #3ECF8E;;">Hiburan</text></p>
                </div>
              </div>
              <!-- Kategori -->
        ...
        <div class="row">
          ...
          <?php
            ...
            $sql = "SELECT * FROM `teknologi` order by id desc LIMIT $start, $perPage";
          ...
          <?php 
            $data = mysqli_query($con, "SELECT * FROM `teknologi`");
            $jmlBaris = mysqli_num_rows($data);
            $halaman = ceil($jmlBaris/$perPage); 
            for($i = 1; $i<=$halaman; $i++){
              echo "<a href=?Halaman=$i class='page'>$i </a>";
            }
          ?>
          <!-- End Col -->
        </div>
