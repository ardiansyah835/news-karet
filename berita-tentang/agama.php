        ...
        <div class="row space-100">
          <div class="col-lg-6 col-md-12 col-xs-12">
            <div data-aos="fade-right" class="contents">
              <h2 class="head-title">Kamu berada di <text style="color: #3ECF8E;;">Menu agama</text></h2>
              <p>
                Di menu <text style="color: #3ECF8E;;">Agama</text> ini kalian akan menemukan berita tentang <text style="color: #3ECF8E;;">Agama</text> untuk wilayah Kp. karet
              </p>
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="blog-text section-header text-center">
              <div>
                <h2 class="section-title">Kategori agama</h2>
                <div class="desc-text">
                  <p>Berikut adalah berita dengan kategori <text style="color: #3ECF8E;;">Agama</text></p>
                </div>
              </div>
              <!-- Kategori -->
        ...
        <div class="row">
          ...
          <?php
            ...
            $sql = "SELECT * FROM `agama` order by id desc LIMIT $start, $perPage";
          ...
          <div class="col-lg-4 col-md-6 mb-3 col-xs-12 blog-item">
            ...
            <div class="blog-item-wrapper">
              ...
              <div class="blog-item-text">
                ...
                <a href="../detail/agama.php?id=<?= $id['id']; ?>" class="read-more">Detail</a>
              </div>
              <div class="author">
                <span class="name"
          ...
          <?php 
            $data = mysqli_query($con, "SELECT * FROM `agama`");
