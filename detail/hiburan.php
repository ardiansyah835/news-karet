        ...
        <div class="row space-100">
          <div class="col-lg-6 col-md-12 col-xs-12">
            <div data-aos="fade-right" class="contents">
              <h2 class="head-title">Kamu berada di <text style="color: #3ECF8E;;">Menu hiburan</text></h2>
              <p>
                Di menu <text style="color: #3ECF8E;;">Hiburan</text> ini kalian akan menemukan berita tentang <text style="color: #3ECF8E;;">Hiburan</text> untuk wilayah Kp. karet
              </p>
      ...
      <div class="container">
          ...
          <div class="col-lg-12">
            <div class="blog-text section-header text-center">
              <div>
                ...
                <div class="desc-text">
                  <p>Berikut adalah berita dengan kategori <text style="color: #3ECF8E;;">Hiburan</text></p>
                </div>
              </div>
              <!-- Kategori -->
        ...
        <div class="row">
          ...
          <?php
            ...
            $sql = "SELECT * FROM `hiburan` order by id desc LIMIT $start, $perPage";
          ...
          <?php 
            $data = mysqli_query($con, "SELECT * FROM `hiburan`");
