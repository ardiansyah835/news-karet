                ...
                <div class="col">
                  <div class="card">
                    <div class="card-body">
                      ...
                      <p class="card-text">
                        Berita tentang <span style="color: red;">Agama</span> ada disini
                      </p>
                      <a href="http://<?= $_SERVER['SERVER_NAME'] ?>/news-karet/kategori/agama.php" class="btn btn-danger"><i class="nav-icon bi bi-box-arrow-right"></i> Klik disini</a>
                    </div>
                  </div>
                </div>
                <div class="col">
                  <div class="card">
                    <div class="card-body">
                      ...
                      <a href="http://<?= $_SERVER['SERVER_NAME'] ?>/news-karet/kategori/ekonomi.php" class="btn btn-danger"><i class="nav-icon bi bi-box-arrow-right"></i> Klik disini</a>
                    </div>
                  </div>
                </div>
                <div class="col">
                  <div class="card">
                    <div class="card-body">
                      ...
                      <a href="http://<?= $_SERVER['SERVER_NAME'] ?>/news-karet/kategori/hiburan.php" class="btn btn-danger"><i class="nav-icon bi bi-box-arrow-right"></i> Klik disini</a>
                    </div>
                  </div>
                </div>
                <div class="col">
                  <div class="card">
                    <div class="card-body">
                      ...
                      <p class="card-text">
                        Berita tentang <span style="color: red;">Politik</span> ada disini
                      </p>
                      <a href="http://<?= $_SERVER['SERVER_NAME'] ?>/news-karet/kategori/politik.php" class="btn btn-danger"><i class="nav-icon bi bi-box-arrow-right"></i> Klik disini</a>
                    </div>
                  </div>
                </div>
                <div class="col">
                  <div class="card">
                    <div class="card-body">
                      ...
                      <a href="http://<?= $_SERVER['SERVER_NAME'] ?>/news-karet/kategori/teknologi.php" class="btn btn-danger"><i class="nav-icon bi bi-box-arrow-right"></i> Klik disini</a>
                    </div>
                  </div>
                </div>
              </div>
