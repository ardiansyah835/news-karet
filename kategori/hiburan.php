        ...
        <nav>
          <ol class="breadcrumb">
            <li class="breadcrumb-item active">
              Anda berada di menu <span style="color: red">Hiburan</span>
            </li>
          </ol>
        </nav>
      </div>
            ...
            <div class="row">
              ...
              <div class="card" style="margin-left: 12px;">
                ...
                <div class="card-body">
                  ...
                  <p>Berikut ini adalah berita tentang hiburan</p>
                  ...
                  <table class="table datatable">
                    ...
                    <tbody>
                      <?php
                      $no = 1;
                      $tampil = mysqli_query($con, "SELECT * FROM `hiburan` order by id desc");
