...
if(isset($_POST['hapus'])){
  $id = $_POST['id'];
  $q = mysqli_query($con, "DELETE FROM `agama` WHERE id = '$id'");
}
?>
<!DOCTYPE html>
<html lang="en">
        ...
        <nav>
          <ol class="breadcrumb">
            <li class="breadcrumb-item active">
              Anda berada di menu <span style="color: red">Agama</span>
            </li>
          </ol>
        </nav>
      </div>
            ...
            <div class="row">
              ...
              <div class="card" style="margin-left: 12px;">
                ...
                <div class="card-body">
                  ...
                  <p>Berikut ini adalah berita tentang agama</p>
                  ...
                  <table class="table datatable">
                    ...
                    <tbody>
                      <?php
                      $no = 1;
                      $tampil = mysqli_query($con, "SELECT * FROM `agama` order by id desc");
